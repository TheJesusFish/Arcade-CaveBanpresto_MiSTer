...
// Hand-maintained game table for the active Z80 sound-family board profiles.
module CaveGameConfig (
  ...
  always @* begin
    ...
    case (game_index)
      ...
      GAME_METMQSTR: begin
        eeprom_offset         = 32'h0018_0000;
        sound_0_rom_offset    = 32'h0018_0080;
        sound_1_rom_offset    = 32'h00fc_0080;
        sound_2_rom_offset    = 32'h011c_0080;
        layer_0_format        = GFX_FORMAT_4BPP;
        layer_0_rom_offset    = 32'h009c_0080;
        layer_0_palette_bank  = 2'h1;
        layer_1_format        = GFX_FORMAT_4BPP;
        layer_1_rom_offset    = 32'h00bc_0080;
        layer_1_palette_bank  = 2'h1;
        layer_2_format        = GFX_FORMAT_4BPP;
        layer_2_rom_offset    = 32'h00dc_0080;
        layer_2_palette_bank  = 2'h1;
        sprite_rom_offset     = 32'h001c_0080;
      end
